...
const NAV_ITEMS = [
  ...
  { key: 'brand-health', label: 'Brand Health', icon: '♡', href: '/brand-health' },
  { key: 'all', label: 'All Feeds', icon: '○', href: '/feeds' },
  { key: 'google', label: 'Google', icon: 'G', href: '/feeds/google' },
  { key: 'reddit', label: 'Reddit', icon: 'R', href: '/feeds/reddit' },
  { key: 'pinterest', label: 'Pinterest', icon: 'P', href: '/feeds/pinterest' },
  { key: 'news', label: 'News', icon: 'N', href: '/feeds/news' },
  { key: 'amazon', label: 'Amazon', icon: 'A', href: '/feeds/amazon' },
  { key: 'nykaa', label: 'Nykaa', icon: 'Ny', href: '/feeds/nykaa' },
  { key: 'flipkart', label: 'Flipkart', icon: 'F', href: '/feeds/flipkart' },
  { key: 'twitter', label: 'X / Twitter', icon: 'X', href: '/feeds/twitter' },
  { key: 'instagram', label: 'Instagram', icon: 'Ig', href: '/feeds/instagram' },
  { key: 'competitors', label: 'Competitors', icon: '⚔', href: '/competitors' },
];
